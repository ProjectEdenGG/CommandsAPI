...
public class TimeUtils {
	...
	public static LocalDate parseDate(String input) {
		...
		throw new CustomCommandException("Could not parse date, correct format is MM/DD/YYYY");
	}
	...
	public static LocalDateTime parseDateTime(String input) {
		...
		throw new CustomCommandException("Could not parse date, correct format is YYYY-MM-DDTHH:MM:SS");
	}
	...
	public enum TimespanElement {
		...
		public long of(String input) {
			try {
				...
				throw new CustomCommandException("Invalid " + name().toLowerCase() + ": &e" + input);
			}
		}
